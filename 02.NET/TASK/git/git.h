...
#endif
// 设备信息
#define PROID "625921"	   // 产品ID
#define DEVID "1183943270" // 设备ID
#define AUTH_INFO "10"	   // 鉴权信息

// MQTT主题 /broadcast/
#define S_TOPIC_NAME "baby_topic"	 // 硬件订阅的主题
#define P_TOPIC_NAME "babyapp_topic" // 硬件发布的主题
...
typedef struct
{
	...
	U8 music_state;	 // 音乐状态
	U8 waning_state; // 警告状态
	U8 bed_state;    // 床状态
	U8 waning_time;	 // 警告结束时间
	U8 shake_state;	 // 震动状态
